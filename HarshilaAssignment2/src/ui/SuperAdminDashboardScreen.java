...
public class SuperAdminDashboardScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MainLogoutButton1 = new javax.swing.JButton();
        MainLogoutButton2 = new javax.swing.JButton();
        ...
        superadmin_Hospitals_Screen_All_Hospitals_Table.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        hospital_Screen_hospitalNameTextField.setText("TechnoClever Hospital");
        ...
        hospital_Screen_hospitalAddressTextField.setText("75 Saint Alphonsos Street");
        ...
        hospital_Screen_hospitalCommunityComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Boston", "Mountain View", "Redmond", "Menlo Park", "Seattle" }));
        ...
        superAdminDashboardScreen_DeleteUpdatePanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, superAdminDashboardScreen_DeleteUpdatePanelLayout.createSequentialGroup()
                ...
                .addComponent(hospital_Screen_update_button, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jPanel26Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel26Layout.createSequentialGroup()
                ...
                .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(superAdminDashboardScreen_DeleteUpdatePanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(superAdminDashboardScreen_Reset_AddButtonPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanel17Layout.createSequentialGroup()
                        .addComponent(Person_Registeration_Screen_DoctorId_Label, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        MainLabel.setText("Get TechnoClever Hospital Management System Only For $999,99");

        MainLogoutButton1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        MainLogoutButton1.setText("FEEDBACK");
        MainLogoutButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MainLogoutButton1ActionPerformed(evt);
            }
        });

        MainLogoutButton2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        MainLogoutButton2.setText("BUY NOW");
        MainLogoutButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MainLogoutButton2ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(MainLogoutButton2)
                .addGap(18, 18, 18)
                .addComponent(MainLogoutButton1)
                .addGap(18, 18, 18)
    ...
    private void hospital_Screen_update_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hospital_Screen_update_buttonActionPerformed
        ...
        if (HOSPITAL_INDEX_TO_UPDATE_DELETE != -1) {
            ...
            hospital.setHospitalPincode(hospital_Screen_hospitalPincodeTextField.getText().trim());
    ...
    private void superadmin_Patient_Screen_UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_superadmin_Patient_Screen_UpdateButtonActionPerformed
        ...
        ArrayList<Patient> patientsArraylist = DataStorageClass.hospital_Screen_HospitalArrayList.get(selectedHospitalIndex).getEnrolledPatientsArrayList();
...
//       DataStorageClass.person_registration_ArrayList.set(selectedindex, person);
    ...
    private void Person_Screen_Search_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Person_Screen_Search_ButtonActionPerformed
        ...
        for (int i = 0; i < DataStorageClass.hospital_Screen_HospitalArrayList.size(); i++) {
            if (DataStorageClass.hospital_Screen_HospitalArrayList.get(i).getHospitalPincode().equals(searchedPinCode)) {
...
//                    i = DataStorageClass.hospital_Screen_HospitalArrayList.size();
//                    j = DataStorageClass.hospital_Screen_HospitalArrayList.get(i).getEnrolledPatientsArrayList().get(j).getEncountersArraylist().size();
    ...
    private void MainLogoutButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MainLogoutButton1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MainLogoutButton1ActionPerformed

    private void MainLogoutButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MainLogoutButton2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MainLogoutButton2ActionPerformed
    ...
    private javax.swing.JButton MainLogoutButton1;
    private javax.swing.JButton MainLogoutButton2;
            ...
            case "viewAllHospitalsTable" -> {
                for (int i = 0; i < tableDataArrayList.size(); i++) {
                    defaultTableModel.addRow(new String[]{String.valueOf(i + 1),
                        ...
                        tableDataArrayList.get(i).getHospitalPincode()
                    });
                }
                    ...
                    table.addMouseListener(new MouseAdapter() {
                        ...
                        public void mousePressed(MouseEvent mouseEvent) {
                            ...
                            if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
                                ...
                                hospital_Screen_hospitalPincodeTextField.setText(hospitalToSelect.getHospitalPincode());
                ...
                table.addMouseListener(new MouseAdapter() {
                    public void mousePressed(MouseEvent mouseEvent) {
                        ...
                        if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
                            ...
                            table.clearSelection();
                            autofill_superadmin_add_doctor_data(tableDataArrayList);
    ...
    private void autofill_superadmin_add_doctor_data(ArrayList<Doctor> doctorsList) {
        superAdmin_Doctor_Screen_Delete_UpdatePanel.setVisible(true);
        Doctor doctor = new Doctor();
        Hospital hospital = new Hospital();
        ArrayList<Doctor> tempdoctorsList = new ArrayList<>();
        doctor = doctorsList.get(DOCTOR_INDEX_TO_UPDATE_DELETE);
        int hospitalindextoupdate, doctorindextoupdate = 0;
...
//        HOSPITAL_ARRAYLIST_INDEX = -1;
    ...
    private void setdoctoraccordingtohospital(int selectedHospitalIndex, JList listToSet) {
        doctorsinhospital = new ArrayList<>();
        ArrayList patientsArrayList = new ArrayList<>();
        DefaultListModel doctorsListModel = new DefaultListModel();
...
//        if (!patientsArrayList.isEmpty()) {
//            showAddPatientElements();
////            setDataOnAllPatientsTable("viewAllPatientsTable", superadmin_Patient_Screen_TableDataDefaultTableModel, patientsArrayList, superadmin_Patient_Screen_AllPatients_Table);
//        } else {
//            hideAddPatientElements();
//        }
    }
